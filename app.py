...
# 2. Top Anchor (This is what the 'Return to Top' button points to)
...
# "Return to Top" now sits at the very top of the sidebar
# It uses a link styled as a button to jump to the #top anchor
st.sidebar.markdown("""
